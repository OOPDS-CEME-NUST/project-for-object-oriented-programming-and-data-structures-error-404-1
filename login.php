...
<body>
	...
	<section class="section-padding-bottom">
		<div class="container">
			...
			<div class="row">
				<!-- contact form -->
		<center>		<form action="login_action.php" method="post" class="tm-contact-form">
					<div class="col-lg-6 col-md-6 tm-contact-form-input">
						<div class="form-group">
							<input type="text" id="contact_name" name="usern" class="form-control" placeholder="Username" />
						</div>
						<div class="form-group">
							<input type="password" id="contact_email"  name="pass" class="form-control" placeholder="Password" />
						</div>
